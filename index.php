						...
						<div class="card">
							<div class="card-body">
								...
								<ul class="fa-ul">
									...
									<li class="mb-2"><i class="fa-li fa fa-truck-loading fa-flip-horizontal"></i><strong><?= __('mounting',$lang) ?>:</strong> 10 <?= __('minutes',$lang) ?></li>
									<li class="mb-2"><i class="fa-li fa fa-truck-loading"></i><strong><?= __('unmounting',$lang) ?>:</strong> 10 <?= __('minutes',$lang) ?></li>
					...
					<div class="col-lg-4 order-sm-1 offset-lg-1 pb-4 pt-4 pt-lg-0" data-aos="fade-right" data-aos-delay="450">
						<div class="card">
							<div class="card-body">
								...
								<ul class="fa-ul">
									<li class="mb-2"><i class="fa-li fa fa-clock"></i><strong><?= __('duration',$lang) ?>:</strong> 40 <?= __('minutes',$lang) ?></li>
									<li class="mb-2"><i class="fa-li fa fa-truck-loading fa-flip-horizontal"></i><strong><?= __('mounting',$lang) ?>:</strong> 5 <?= __('minutes',$lang) ?></li>
									<li class="mb-2"><i class="fa-li fa fa-truck-loading"></i><strong><?= __('unmounting',$lang) ?>:</strong> 10 <?= __('minutes',$lang) ?></li>
